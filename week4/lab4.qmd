...
**A1**: Difference in proportions

### State your null and alternative hypotheses

**Q2: What are your null and alternative hypotheses?**

H0: *No difference between two methods*

HA: *Popsicle Stick method has a greater success than Garden Staple Method*
...
**A4**: We would need to shuffle the treatment column to break the association.
...
permutation_diff_props <- permutation_props$prop_success[2] - 
permutation_props$prop_success[1]
...
```{r}
#| label: q7
null_distribution_list <- as.data.frame(null_distribution)

observed <- restoration_summary$prop_success[2] - restoration_summary$prop_success[1]
...
# p_val <- null_distribution_list %>% 
#   filter(null_distribution > permutation_diff_props) %>% 
#   nrow() / 1000

p_val <- sum(null_distribution > observed) / length(null_distribution)
